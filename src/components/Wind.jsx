...
export default function Wind({number1, number2}) {
  ...
  <React.Fragment>
    <CardContent>
        ...
        <WindPowerOutlinedIcon sx={{ marginRight:'7PX'}}/> WIND 
      </Typography>
      <Box sx={{ display: 'flex', alignItems: 'left', justifyContent: '' }}>   
        ...
        <Typography variant="h8" component="div" style={{alignItems:'',marginLeft:'8px', color: 'rgba(199, 196, 196, 0.7)',}}>MPH</Typography> 
        <Typography variant="h8" component="div" style={{alignItems:'',marginLeft:'8px'}}>WIND</Typography>
        </Stack>
       ...
       <Box sx={{ display: 'flex', alignItems: 'left', justifyContent: '' }}>   
        ...
        <Stack direction={'column'} spacing={1} sx={{marginTop:'15px'}}>
        <Typography variant="h8" component="div" style={{alignItems:'',marginLeft:'8px',color: 'rgba(199, 196, 196, 0.7)',}}>KPH</Typography> 
        <Typography variant="h8" component="div" style={{alignItems:'',marginLeft:'8px'}}>WIND</Typography>
        </Stack>
